...
template <typename T>
void MinHeap<T>::ReHeapDown(int inParent, int inBottom) {
	int tempMaxChild;
	int tempLeftChild;
	int tempRightChild;
...
template <typename T>
void MinHeap<T>::ReHeapUp(int inRoot, int inBottom) {
	int tempParent;
...
template <typename T>
void MinHeap<T>::Delete(T inData, bool& isFound, int inParent) {
	int tempLeftChild;
	int tempRightChild;
...
template <typename T>
void MinHeap<T>::Retrieve(T& inData, bool& isFound, int inParent) {
	int tempLeftChild;
	int tempRightChild;
